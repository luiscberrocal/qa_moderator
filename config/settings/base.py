...
MIGRATION_MODULES = {
    'sites': 'qa_moderator.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'qa_moderator.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'qa_moderator.users.adapters.SocialAccountAdapter'
...
QUESTIONS_ACTIVE = env.bool('QUESTIONS_ACTIVE', default=True)
QUESTIONS_MAX_MODERATORS_NUM = env.int('QUESTIONS_MAX_MODERATORS_NUM', 3)
